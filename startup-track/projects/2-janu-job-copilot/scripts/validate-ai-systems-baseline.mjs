...
const required = {
  ...
  'CURRENT_STATE.md': ['## Public/private evidence boundary', '## 1. Current executable/control-plane state', '## 5. Current known gaps'],
  ...
  'EVAL_PLAN.md': ['## Public/private eval boundary', '## 2. Core capability evals', '## 9. Promotion gate'],
  'BASELINE_SCORECARD.md': ['## Public/private scorecard rule', '## 1. Current live conclusion', '## 5. Comparison rule'],
  ...
  'MONITORING_ALERTS.md': ['## 2. Outcome/invariant monitors', '## 4. Notification policy']
};

...
console.log(JSON.stringify({status:'PASS',file:target,changed:s!==before,contract:CONTRACT,payloadContract:PAYLOAD_CONTRACT,lock:true,selfTestGate:true,jdRetrievePayloadUrl:true,maxMutatingAppPerCall:1,anchorFallback:true,syntax:true},null,2));

...
for(const token of [LIVE_REGRESSION,"careerBlock('{{CAREER_BREAK}}',ex.independent_break",'function rendererCareerBreakExperienceLines_(','PREVENTION-RECURRENCE-001'])if(!s.includes(token))throw new Error('Live Career Break binding missing '+token);
